...
Version: `5.4+20260511.d784dad`

This package contains tools for integrating the Ray Optics Simulation engine with other programming languages.

## Download/Update

- [Latest deployment](https://github.com/shihanqu/ray-optics-webgpu/archive/refs/heads/dist-integrations.zip) (compatible with the online app)
...
- `rayOptics.js` - The core simulation engine ([source code](https://github.com/shihanqu/ray-optics-webgpu/blob/master/src/core), [documentation](https://github.com/shihanqu/ray-optics-webgpu/tree/master/src))
