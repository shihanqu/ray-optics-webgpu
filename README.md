...
See [CONTRIBUTING.md](https://github.com/shihanqu/ray-optics-webgpu/blob/master/CONTRIBUTING.md) for the tutorial.
...
The easiest way is to use the built [integration tools](https://github.com/shihanqu/ray-optics-webgpu/tree/dist-integrations). You don't need to clone this repo and build anything, but you still need to have Node.js installed.
