    ...
    <div class="dropdown-menu" id="help-dropdown" ref="helpDropdown" aria-labelledby="helpDropdown">
      <div class="container help-dropdown-inner">
        ...
        <div class="help-popup-footer">
          ...
          <a href="https://github.com/shihanqu/ray-optics/blob/master/CITATION.md" target="_blank" id="cite-this-project" v-html="$t('main:aboutPage.cite')"></a>
        </div>
      </div>
    </div>

    <a id="github" class="btn" href="https://github.com/shihanqu/ray-optics" target="_blank" v-tooltip-popover="{ title: $t('main:pages.github') }">
