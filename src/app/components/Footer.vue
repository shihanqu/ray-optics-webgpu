...
<template>
  ...
  <div class="footer-right" id="footer-right">
    <a class="btn" href="https://shihanqu.github.io/ray-optics-webgpu/simulator/" target="_blank" id="home" v-tooltip-popover="{ title: $t('main:pages.home') }">
    ...
    <div class="dropdown-menu" id="help-dropdown" ref="helpDropdown" aria-labelledby="helpDropdown">
      <div class="container help-dropdown-inner">
        ...
        <div class="help-popup-footer">
          ...
          <a href="https://shihanqu.github.io/ray-optics-webgpu/simulator/" target="_blank" id="about" v-html="$t('main:pages.about')"></a>
          <span class="help-divider-dot" aria-hidden="true">&middot;</span>
          <a href="https://github.com/shihanqu/ray-optics-webgpu/blob/master/CITATION.md" target="_blank" id="cite-this-project" v-html="$t('main:aboutPage.cite')"></a>
        </div>
      </div>
    </div>

    <a id="github" class="btn" href="https://github.com/shihanqu/ray-optics-webgpu" target="_blank" v-tooltip-popover="{ title: $t('main:pages.github') }">
