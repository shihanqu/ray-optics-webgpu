...
- `src/core` contains the source code for the core modules of the simulator, which is to be built using Webpack. To understand the structure of the code, see the [documentation](https://github.com/shihanqu/ray-optics-webgpu/tree/master/src) for more information. The documentation is generated from the jsdoc comments in the code.
