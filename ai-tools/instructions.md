...
If you found that the user's request requires things which is not clear from your knowledge file, you may check the repo https://github.com/shihanqu/ray-optics-webgpu or the documentation of the code https://phydemo.app/ray-optics/docs/index.html for more information.